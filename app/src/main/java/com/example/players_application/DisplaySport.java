...
public class DisplaySport extends AppCompatActivity {
    ...
    private Boolean updateMainFragment(Integer integer){
        switch (integer) {
            case R.id.action_home:
               // startActivity(new Intent(this, DisplaySport.class));
                break;
            case R.id.action_match:
                startActivity(new Intent(this, DisplayMatch.class));
                break;
            case R.id.action_training:
                startActivity(new Intent(this, DisplayTraining.class));
                break;
        }
        return true;
    }
